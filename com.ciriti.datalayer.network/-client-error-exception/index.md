//[project](../../index.md)/[com.ciriti.datalayer.network](../index.md)/[ClientErrorException](index.md)



# ClientErrorException  
 [androidJvm] class [ClientErrorException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [RuntimeException](https://developer.android.com/reference/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#com.ciriti.datalayer.network/ClientErrorException/cause/#/PointingToDeclaration/)|  [androidJvm] open override val [cause](index.md#com.ciriti.datalayer.network/ClientErrorException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#com.ciriti.datalayer.network/ClientErrorException/message/#/PointingToDeclaration/)|  [androidJvm] open override val [message](index.md#com.ciriti.datalayer.network/ClientErrorException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
