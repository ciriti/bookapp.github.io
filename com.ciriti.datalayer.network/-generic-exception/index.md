//[project](../../index.md)/[com.ciriti.datalayer.network](../index.md)/[GenericException](index.md)



# GenericException  
 [androidJvm] class [GenericException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [RuntimeException](https://developer.android.com/reference/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#com.ciriti.datalayer.network/GenericException/cause/#/PointingToDeclaration/)|  [androidJvm] open override val [cause](index.md#com.ciriti.datalayer.network/GenericException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#com.ciriti.datalayer.network/GenericException/message/#/PointingToDeclaration/)|  [androidJvm] open override val [message](index.md#com.ciriti.datalayer.network/GenericException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
