//[project](../../index.md)/[com.ciriti.datalayer.network](../index.md)/[RedirectException](index.md)



# RedirectException  
 [androidJvm] class [RedirectException](index.md)(**message**: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [RuntimeException](https://developer.android.com/reference/java/lang/RuntimeException.html)   
...
|  Name|  Summary| 
|---|---|
| [cause](index.md#com.ciriti.datalayer.network/RedirectException/cause/#/PointingToDeclaration/)|  [androidJvm] open override val [cause](index.md#com.ciriti.datalayer.network/RedirectException/cause/#/PointingToDeclaration/): [Throwable](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-throwable/index.html)?   <br>
| [message](index.md#com.ciriti.datalayer.network/RedirectException/message/#/PointingToDeclaration/)|  [androidJvm] open override val [message](index.md#com.ciriti.datalayer.network/RedirectException/message/#/PointingToDeclaration/): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)?   <br>
